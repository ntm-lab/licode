...
config.erizoController.hostname = 'localhost'; //default value: ''
...
config.erizoController.ssl_key = '/opt/cert/key.pem';
config.erizoController.ssl_cert = '/opt/cert/cert.pem';
